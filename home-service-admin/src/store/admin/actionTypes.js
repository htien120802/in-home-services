...
export const GET_SALES_STATISTICS_BY_PROVIDER = 'GET_SALES_STATISTICS_BY_PROVIDER';
export const GET_SALES_STATISTICS_BY_PROVIDER_SUCCESS = 'GET_SALES_STATISTICS_BY_PROVIDER_SUCCESS';
export const GET_SALES_STATISTICS_BY_PROVIDER_FAILED = 'GET_SALES_STATISTICS_BY_PROVIDER_FAILED';

export const GET_QUANTITY_STATISTICS_BY_PROVIDER = 'GET_QUANTITY_STATISTICS_BY_PROVIDER';
export const GET_QUANTITY_STATISTICS_BY_PROVIDER_SUCCESS = 'GET_QUANTITY_STATISTICS_BY_PROVIDER_SUCCESS';
export const GET_QUANTITY_STATISTICS_BY_PROVIDER_FAILED = 'GET_QUANTITY_STATISTICS_BY_PROVIDER_FAILED';

export const GET_TOP_SALES_PROVIDER = 'GET_TOP_SALES_PROVIDER';
export const GET_TOP_SALES_PROVIDER_SUCCESS = 'GET_TOP_SALES_PROVIDER_SUCCESS';
export const GET_TOP_SALES_PROVIDER_FAILED = 'GET_TOP_SALES_PROVIDER_FAILED';

export const GET_TOP_QUANTITY_PROVIDER = 'GET_TOP_QUANTITY_PROVIDER';
export const GET_TOP_QUANTITY_PROVIDER_SUCCESS = 'GET_TOP_QUANTITY_PROVIDER_SUCCESS';
export const GET_TOP_QUANTITY_PROVIDER_FAILED = 'GET_TOP_QUANTITY_PROVIDER_FAILED';
